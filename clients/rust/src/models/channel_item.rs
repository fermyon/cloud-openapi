...
pub struct ChannelItem {
    ...
    pub active_revision: Option<Box<models::RevisionItem>>,
    ...
    pub app_summary: Option<Box<models::AppSummaryDto>>,
    #[serde(rename = "environmentVariables")]
    pub environment_variables: Vec<models::EnvironmentVariableItem>,
}

impl ChannelItem {
    pub fn new(id: uuid::Uuid, app_id: uuid::Uuid, name: String, domain: String, revision_selection_strategy: models::ChannelRevisionSelectionStrategy, desired_status: String, environment_variables: Vec<models::EnvironmentVariableItem>) -> ChannelItem {
        ChannelItem {
            id,
            app_id,
            name,
