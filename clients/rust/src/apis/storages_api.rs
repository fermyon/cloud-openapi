...
pub async fn api_storages_get(configuration: &configuration::Configuration, search_text: Option<&str>, page_index: Option<i32>, page_size: Option<i32>, is_sorted_ascending: Option<bool>, api_version: Option<&str>) -> Result<crate::models::StringPage, Error<ApiStoragesGetError>> {
