...
/// struct for typed errors of method [`api_key_value_pairs_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiKeyValuePairsPostError {
...
pub async fn api_key_value_pairs_post(configuration: &configuration::Configuration, create_key_value_pair_command: crate::models::CreateKeyValuePairCommand, api_version: Option<&str>) -> Result<(), Error<ApiKeyValuePairsPostError>> {
    ...
    let local_var_uri_str = format!("{}/api/key-value-pairs", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&create_key_value_pair_command);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiKeyValuePairsPostError> = serde_json::from_str(&local_var_content).ok();
