# Rust API client for fermyon-cloud-openapi
...
Put the package under your project folder in a directory named `fermyon-cloud-openapi` and add the following to `Cargo.toml` under `[dependencies]`:

```
fermyon-cloud-openapi = { path = "./fermyon-cloud-openapi" }
```
